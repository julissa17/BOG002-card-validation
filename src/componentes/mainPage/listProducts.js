...
function renderProducts(categoria,products){
    ...
    let containerProduct = typeof products == 'object' ? products : document.querySelector(".productos__container")
    // let containerProduct = document.querySelector(".productos__container")
    containerProduct.innerHTML = ''
  
    categoria.listProducts.length == 0 ? containerProduct.innerHTML = '<img class ="notFound" src="./assets/404.jpg" alt="">' : ''
